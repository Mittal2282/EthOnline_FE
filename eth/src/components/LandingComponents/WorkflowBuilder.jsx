              ...
              <div className="relative">
                <div className={`bg-white/70 backdrop-blur-lg border-2 rounded-xl p-4 shadow-sm transition-all duration-300 ${
                  ...
                  <textarea
                    ...
                    className="w-full h-32 resize-none bg-transparent text-gray-900 placeholder-gray-500 focus:outline-none text-base leading-relaxed"
                  />
                  
                  <motion.button
                    type="button"
                    onClick={handleSubmit}
                    className="absolute bottom-4 right-4 bg-transparent border border-gray-300 text-gray-700 px-5 py-2.5 rounded-lg font-medium hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 flex items-center space-x-2 text-sm"
